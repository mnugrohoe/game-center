/**
 * Kings visual constants — color palettes for region rendering.
 * Split out so they can be imported without pulling in any algorithm code.
 */

/** Dark background fills for game board regions (12 colors, cycled). */
...
/** Semi-transparent border colors for game board regions. */
...
/** Dark fills for solver canvas regions. */
...
/** Border colors for solver canvas regions. */
